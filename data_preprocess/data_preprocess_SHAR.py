...
# from data_preprocessing.base import BaseDataset, check_path ##yw: copy these two functions from other files
from data_preprocess_wisdm import BaseDataset, check_path
...
if __name__ == '__main__':
    ...
    output_dir = r'./data/SHAR'
    unimib_path = Path('./UniMiB-SHAR/data')
    unimib = UniMib(unimib_path)
    x, y = unimib.load(data_type='full')
    print('Check y labels', y[0:1000])
